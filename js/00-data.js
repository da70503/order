...
// ⚠️v2.6.40 升級需求（分段放大制）：取消高等打怪經驗遞減後，改由高等升級需求變高承擔難度。
//   EXP_REQ_CLASSIC 保留供 expMigV=2→3 存檔回遷（天堂表→本制）換算，遊戲邏輯不再使用。
...
function getExpReq(lv) { return _expReqOldV1(lv); }
